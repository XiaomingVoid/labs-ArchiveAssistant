...
internal class MemorialAssets(context: Context) {
  ...
  private val fallbackCoverTexture: Bitmap? =
    BitmapFactory.decodeResource(
      resources,
  ...
  private val generatedCoverTextures: List<Bitmap?> =
    listOf(
  ...
  private val stampDislikeTexture: Bitmap? =
    BitmapFactory.decodeResource(
        resources,
