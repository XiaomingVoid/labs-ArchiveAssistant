...
internal class MemorialPaints(
    ...
    val foldShadow = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        style = Paint.Style.FILL
    }

    val paperAging = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        style = Paint.Style.FILL
    }

    val paper = Paint(Paint.ANTI_ALIAS_FLAG or Paint.FILTER_BITMAP_FLAG).apply {
        alpha = 138
    }

    val cover = Paint(Paint.ANTI_ALIAS_FLAG or Paint.FILTER_BITMAP_FLAG)

    val buttonImage = Paint(Paint.ANTI_ALIAS_FLAG or Paint.FILTER_BITMAP_FLAG).apply {
        alpha = 232
    }
    ...
    val author = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
    ...
    val itemTitle = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
        color = AndroidColor.rgb(26, 26, 26)
        textSize = sp(18f)
        typeface = assets.heritageTypeface
    ...
    val itemMeta = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
    ...
    val cinnabar = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
    ...
    val sealText = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
        color = AndroidColor.rgb(184, 62, 47)
        textSize = sp(22f)
        typeface = assets.heritageTypeface
        textAlign = Paint.Align.CENTER
    ...
    val stampErase = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        style = Paint.Style.FILL
    ...
    val toolbar = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        style = Paint.Style.FILL
        color = AndroidColor.argb(214, 255, 246, 221)
    }

    val toolbarStroke = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        style = Paint.Style.STROKE
    ...
    val toolbarText = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
